...
import static org.serious.dev.exception.ErrorCode.POST_RESERVATION_ERROR;

public class PostReservationException extends RuntimeException implements HasErrorCode {

    private static final ErrorCode ERROR_TYPE = POST_RESERVATION_ERROR;
